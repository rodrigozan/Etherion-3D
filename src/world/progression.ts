...
export type RegionId = 'hill' | 'village' | 'forest';
...
export const isRegionUnlocked = (id: RegionId, state: Progress) => id==='hill' ? true : id==='village' ? isVillageUnlocked(state) : isForestUnlocked(state);
